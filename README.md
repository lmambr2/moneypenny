...
- **Org economy orders** — `!mine` / `!refine` (seed ores), `!craft` / `!econ blueprints` (sc-craft.tools), `!trade` (sc-trade.tools, token), `!econ prices` (UEX). No scrapers. → **[docs/economy.md](./docs/economy.md)**
