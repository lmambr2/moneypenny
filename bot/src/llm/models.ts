...
export const GEMMA4_E2B_QAT =
  "hf.co/unsloth/gemma-4-E2B-it-qat-GGUF:UD-Q4_K_XL" as const;

export const GEMMA4_12B_QAT =
  "hf.co/unsloth/gemma-4-12B-it-qat-GGUF:UD-Q4_K_XL" as const;
...
export const GEMMA4_31B_QAT =
  "hf.co/unsloth/gemma-4-31B-it-qat-GGUF:UD-Q4_K_XL" as const;