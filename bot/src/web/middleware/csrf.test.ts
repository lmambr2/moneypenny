...
describe("csrfOriginCheck middleware", () => {
  ...
  // Documents the server side of the referrer-policy outage: a `no-referrer`
  // document policy makes the browser send the literal `Origin: null` on
  // same-origin POSTs, which this guard cannot parse a host from and rejects.
