...
function stub(platform: MusicProvider["platform"], canHandle?: (q: string) => boolean): MusicProvider {
...
describe("playback/providers", () => {
  ...
  it("pickProvider honors flags before auto-routing", () => {
    ...
    expect(pickProvider(new Set(), local, youtube, stream, "https://youtu.be/x").platform).toBe("youtube");
