...
> On `feat/rust-bot-rewrite` radio is **rewrite Phase 7** (`crates/mp-radio`):
> director, local seed, `!radio`, Settings flags. YouTube/ACE-Step/Icecast still
> Node-only. See [rust-rewrite.md](./rust-rewrite.md).
>
