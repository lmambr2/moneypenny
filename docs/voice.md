...
- Keep **Duck music while listening** on; duck volume default **25** (soft). Raise toward 40 if music still drowns STT, lower toward 10 if the bot’s music bleeds into the mic.
